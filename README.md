...
* **🗣️ Automated Transcription:** Converts speech to text with high accuracy using AI models.
...
* **⏯️ Interactive Playback:** Click on any sentiment point or transcript segment to jump the audio player to that exact second.
...
│   │   ├── App.jsx         # Main Logic & Visualization
│   │   └── main.jsx        # Entry point
│   └── package.json
│
├── server/                 # Flask Backend
│   ├── uploads/            # Temp storage for raw audio
│   ├── processed/          # Temp storage for JSON results
